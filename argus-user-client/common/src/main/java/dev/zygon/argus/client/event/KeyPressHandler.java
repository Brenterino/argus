...
public class KeyPressHandler {
    ...
    public KeyPressHandler(UnaryOperator<KeyBinding> registerKeyBinding) {
        ping = registerKeyBinding.apply(new KeyBinding("key.argus.ping",
                InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_G, CATEGORY));
        increaseYawSliceDegrees = registerKeyBinding.apply(new KeyBinding("key.argus.yaw.slice.increase",
                InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_9, CATEGORY));
        decreaseYawSliceDegrees = registerKeyBinding.apply(new KeyBinding("key.argus.yaw.slice.decrease",
                InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_7, CATEGORY));
        increaseWaypointDistance = registerKeyBinding.apply(new KeyBinding("key.argus.waypoint.distance.increase",
                InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_ADD, CATEGORY));
        decreaseWaypointDistance = registerKeyBinding.apply(new KeyBinding("key.argus.waypoint.distance.decrease",
                InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_SUBTRACT, CATEGORY));
        toggleChatLocations = registerKeyBinding.apply(new KeyBinding("key.argus.toggle.chat",
                InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_6, CATEGORY));
        toggleColoredNames = registerKeyBinding.apply(new KeyBinding("key.argus.toggle.color",
                InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_5, CATEGORY));
        toggleStreamerMode = registerKeyBinding.apply(new KeyBinding("key.argus.toggle.streaming",
                InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_4, CATEGORY));
        toggleHealthOnly = registerKeyBinding.apply(new KeyBinding("key.argus.toggle.status.health",
